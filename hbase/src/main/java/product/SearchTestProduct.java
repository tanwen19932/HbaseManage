...
//		//产品名
//		//jsonQuery.put(Mapper.AdvancedQuery.FIELD_PRODUCT_NAME, "简笔画");
//		//公司名
//		//jsonQuery.put(Mapper.AdvancedQuery.FIELD_COMPANY_NAME, "北京理工");
//		//行业名
//		//jsonQuery.put(Mapper.AdvancedQuery.FIELD_INDUSTRY_NAME, new String[]{"图书"});
//		//情感
...
////		jsonQuery.put(FieldCompany.PRODUCT_NAME, "test update44444");
...
//		SearchBuilder sb=new SearchBuilder();
//		JSONObject jsonQuery=new JSONObject();
//		jsonQuery.put(Mapper.Query.KEYWORD, "test");
//
//		jsonQuery.put(Mapper.Query.RESULT_TYPE, Constant.QUERY_RESULT_FRONT); //.QUERY_RESULT_ANALYSIS);
//
//		jsonQuery.put(Mapper.Query.PAGE_NO, 1);
...
//		SearchBuilder sb=new SearchBuilder();
//		JSONObject jsonQuery=new JSONObject();
//		jsonQuery.put(Mapper.Query.KEYWORD, "奇酷");
//
//		jsonQuery.put(Mapper.Query.RESULT_TYPE, Constant.QUERY_RESULT_FRONT); //.QUERY_RESULT_ANALYSIS);
//
//		jsonQuery.put(Mapper.Query.PAGE_NO, 1);
