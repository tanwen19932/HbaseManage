...
public class NewsDaoRT {
	protected static Log LOG = LogFactory.getLog(NewsDaoRT.class);
	static final String table_log_name = "NewsArticleBER";
	...
	public NewsDaoRT(boolean isWrite){
		NewsDaoRT.isWrite = isWrite;
	}
