...
public class SimpleApp {
    public static void main(String[] args)
        ...
        String logFile = "/test/NewsInserter.log"; // Should be some file on your system
        SparkConf conf = new SparkConf().setAppName("TEST Application");
        JavaSparkContext sc = new JavaSparkContext("spark://my.master:7077", "Simple Application");
