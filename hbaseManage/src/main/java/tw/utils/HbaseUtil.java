...
public class HbaseUtil {
    ...
    public static void insertData(String tableName, String rowKey, String family, Map<String, String> map)
            throws Exception {
        Connection connection = null;
        try {
            connection = ConnectionFactory.createConnection(configuration);
            ...
            for (Map.Entry<String, String> m : map.entrySet()) {
                put.add(Bytes.toBytes(family), Bytes.toBytes(m.getKey()), Bytes.toBytes(m.getValue()));
            }
    ...
    // 添加一条数据多个内容
    @SuppressWarnings("deprecation")
    public static void insertMultiData(String tableName, String rowKey, String family, Map<String, String> map)
            throws Exception {
        Connection connection = null;
        try {
            connection = ConnectionFactory.createConnection(configuration);
     ...
     */
    @SuppressWarnings("deprecation")
    public static void QueryByConditionRowkey(String tableName, String rowkey, Map<String, String> map) {
        Connection connection = null;
        try {
            ...
            try {
                ...
                if (r.listCells() != null) {
                    for (Cell cell : r.listCells()) {
                        ...
                        String qualifier = (Bytes.toString(cell.getQualifier())).trim();
     ...
     */
    @SuppressWarnings("deprecation")
    public static List<Map<String, String>> QueryAllInfo(String tableName, Scan scan) {
        Connection connection = null;
        try {
            connection = ConnectionFactory.createConnection(configuration);
            HTable table = (HTable) connection.getTable(TableName.valueOf(tableName));
    ...
    public static void getAllRecordToFile(String tableName, String filePath, String family, String column) {
        ...
        try {
            ...
            for (Result r : ss) {
                ...
                FileUtils.fileAppendMethod2(filePath, line);
            }
