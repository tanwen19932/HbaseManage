...
public class DupConstants {
	...
	public static int HBASE_PUT_BUFFER_SIZE=500;
	...
	static{
		...
		String val = prop.getProperty( "translate_server_url", "http://192.168.52.2:4050/translate" );
	...
	public static void main(String[] args) {
		//System.out.println(com.buaa.nlp.util.DupConstants.RESTART_TIME_UNIT);
	}
}
