...
public class DownloadManager {
    ...
    public static void doDownload(String remoteFileUrl, String localFileName)
            throws IOException {
    ...
    // 获取远程文件的大小
    private static long getRemoteFileSize(String remoteFileUrl)
            throws IOException {
    ...
    public static void getByWget(String task)
