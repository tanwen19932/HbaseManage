...
public class ExcelUtil {
     ...
     * @throws IOException
     */
    public static HSSFWorkbook getHExcelWorkbook(String filePath)
            throws IOException {

        return getHExcelWorkbook( new File( filePath ) );
    }

    public static HSSFWorkbook getHExcelWorkbook(File file)
            throws IOException {
    ...
    public static XSSFWorkbook getXExcelWorkbook(String filePath)
            throws IOException {

        return getXExcelWorkbook( new File( filePath ) );
    }

    public static XSSFWorkbook getXExcelWorkbook(File file)
            throws IOException {
