...
public class DownloadThread
    ...
    public void run() {
        ...
        while (true) {
            try {
                ...
                System.out.println( Thread.currentThread().getName() + ".\tDONE!! From " + offsetBefore + "\tTo" + offset + "\t length" + (offset - offsetBefore) );
    ...
    private void writeFile(String fileName, long offset, byte[] bytes, int realLength)
            throws IOException {
