...
public class MySQLConnect {
    ...
    public static Connection getAM2Connection()
            throws SQLException, ClassNotFoundException {
    ...
    public static Connection getAM1Connection()
            throws SQLException, ClassNotFoundException {
    ...
    public static Connection get5Connection()
            throws SQLException, ClassNotFoundException {
        if (connection5 != null) {
    ...
    public static Connection getHMConnection()
            throws SQLException, ClassNotFoundException {
    ...
    public static Connection getConnection(String ip, String table, String user, String password)
            throws SQLException {
