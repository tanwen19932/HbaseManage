...
public class MysqlUniversalDao {
    ...
    void setPreparement(PreparedStatement preparedStatement, int i, Field field, Object obj)
            throws SQLException {
        ...
        try {
            switch (name) {
                ...
                case "float":
                    ...
                    break;
                case "Date":
                    preparedStatement.setDate( i, new java.sql.Date( ((Date) ReflectUtil.invokeObjGetMethod( obj, field.getName() )).getTime() ) );
                    break;
                default:
